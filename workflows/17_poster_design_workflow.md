...
- 用户明确请求服务本项目的宣传封面：平台封面、剧集/短剧封面、竖屏封面、社媒宣传封面、视频封面（缩略图/封面图）或频道主视觉
...
- 用户未请求海报或封面时的常规影视项目
- 与本项目影片内容无关的通用平面设计：头像、壁纸、信息长图、与影片宣传无关的营销图

如果用户目标是海报或封面但前置事实或核心资产尚未完成：
...
- Channel Spec Source：渠道官方规范 / 用户提供规格 / 项目资料 / 待确认；尺寸、安全区、文字区与导出格式以该来源为准，不得凭记忆硬编码平台数值
- Exact Copy Ledger
- 必须使用的授权资产与不可改变元素
- 参考图角色及其授权状态
