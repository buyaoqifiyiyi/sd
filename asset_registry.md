...
- 实际文件：`C:\Users\Lenovo\Documents\Codex\SD Film Projects\PROJECT-ZYH-OTTER-001\asset_registry.md`

执行任何Workflow前，由`references/project_workspace.md`解析Active Project候选，并只按`rules/state_source.md`选择State Source。本兼容入口不维护选择规则。
