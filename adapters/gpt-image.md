...
- **`gpt-image-2`**：任意分辨率——两边均为16的倍数、长边≤3840（4K）、比例≤3:1、像素数655,360–8,294,400。**16:9与9:16、2K/4K均可行**（16:9 2K=`2048×1152`、4K=`3840×2160`；9:16 2K=`1152×2048`、4K=`2160×3840`）。
...
要求16:9、9:16或2K/4K时必须确认当前使用`gpt-image-2`；选用其他版本时据实说明可交付的画幅与分辨率，不得把版本能力差异说成参数问题。资产图的默认类别比例由`rules/02_asset_rules.md`的`Asset Canvas Ratio Default｜资产图画幅默认`拥有，本Adapter只声明可交付的画幅与分辨率。
