...
**AI 影视虚拟制片生产系统** · Skill Version 2026.09.15-r98
...
- **分类型**：悬疑/惊悚、动作、爱情、喜剧、恐怖、犯罪六类各有呈现层倾向与各自的"什么时候不该用"，按项目登记的类型落进同一套视觉语法基线（是候选手段，不是固定套路）
- **分媒介**：真人 / 三维 / 二维三档各有语言——二维档不套用实拍焦段、光比与器材，改走版面与帧感的等效表达，角色资产是设定集与画风锚
- **分画幅**：横屏与竖屏各有构图纪律（双人错位调度、群体纵深、纵向优先的运动方向、平台安全区），按已确认的交付画幅执行，不靠裁切转换
- **分时代**：时代与地域约束画面上的可见事实（技术、器物、服装形制、字体标识、照明条件、称谓与身体距离），并区分已确认来源、推断与不可确认；反刻板，不靠符号堆叠
- **做商业片**：品牌诉求转译为一条注意焦点链与产品角色，可信度靠材质与真实光源建立；商业事实（价格、SKU、Logo 文字、功效、授权）一律不由制作生成，文字级元素留给后期叠加
- **分受众**：学龄前 / 儿童家庭向 / 通用三档各自约束内容适宜性（含可模仿性）、理解难度与表演声音尺度；不推定受众（动画 ≠ 儿童向），不虚构分级条文，儿童向不等于降智
- **拍纪实**：来源台账、重现边界、旁白权限与时间线忠实四道门；**生成画面不得冒充档案**，真实主体授权必须由用户提供
