...
def validate_skill(root: Path, as_json: bool = False) -> int:
    ...
    integration_checks = {
        ...
        "workflows/13_review_workflow.md": ("FX Review", "Performance Review", "表情符合角色基线", "公开状态、短暂泄漏", "Sound Review", "Sequence Coverage Review", "Camera Language QA", "Clip End-State Record / Next-Clip Carryover", "Reference Selection / Routing", "Character Appearance Leakage Check", "人物/道具重置", "相机轴线跳变", "连续慢推", "超过4个Shot", "连续3次", "焦段倾向、摄影机距离", "背景尺度抽动", "主色、辅助色、强调色", "白平衡抽动", "Prompt Attention / Control Allocation", "重要风格标签若保留", "同一标签是否重复解释", "Blender / Unreal式严格物理仿真器"),
